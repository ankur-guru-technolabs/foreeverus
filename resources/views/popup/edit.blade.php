    ...
    <div class="card-content">
      ...
      <div class="row">
        <div class="col s12" id="account">
          ...
          <form id="accountForm" method="post" action="{{ route('popup.edit') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="name" name="name" type="text" class="validate" value="{{$popup_details->name}}"
                  ...
                  <div class="col s12 input-field">
                  Description <textarea name="description" required >{{$popup_details->description}}</textarea>
                    ...
                    @if ($errors->has('description'))
                     ...
                     @endif
                      ...
                      <div class="col s12 input-field">
                    Icon <input type="file"  name="icon" class="validate" id="icon" accept="image/*" >
                  ...
                  <img id="img_db" src="{{$popup_details->icon}}" alt="" style="height: 88px;width: 129px;">

                  <div class="col s12 input-field">
                      Text Color
                    <input type="color" id="txt_color" class="validate" value="{{$popup_details->txt_color}}" >
                  ...
                  <div class="col s12 input-field">
                      Background Color
                    <input type="color" id="bg_color" class="validate" name="bg_color" value="{{$popup_details->bg_color}}" >
             ...
             <div class="col s12 m6">
               <!-- <div class="row">-->
                  Screens
                <select  multiple="multiple" name="screens[]" id="selectpicker" required>
                    
                       @foreach($screens as $key => $type)
                          <option value="{{$type->sid}}" <?php echo (in_array($type->sid, $selected_screens)) ? 'selected' : ''; ?> >{{$type->name}}</option>
                       @endforeach
                   ...
                   @if ($errors->has('screens'))
                     ...
                     @endif
                <!--</div>-->
                 <input type="hidden" value="{{ request()->id }}" name="popid">
              </div> 
             <!-- <div class="col s12 display-flex justify-content-end mt-3">
                <button type="submit" class="btn gethingd-color">
                  Save changes</button>
