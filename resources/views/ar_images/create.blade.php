      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Add Ar</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" enctype='multipart/form-data' action="{{ route('ar_management.store') }}">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="ar_name" type="text" class="validate" value=""
                      data-error=".errorTxt2">
                    <label for="name">Ar Name</label>
                    @if ($errors->has('ar_name'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('ar_name') }}</small>
                     @endif
                  </div>
                </div>
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="coin" type="text" class="validate" value=""
                      data-error=".errorTxt2">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="ar_image" type="file" class="validate" value=""
                      data-error=".errorTxt2">
                    <label for="name"></label>
                    @if ($errors->has('ar_image'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('ar_image') }}</small>
                     @endif
                  </div>
                </div>
              </div>
