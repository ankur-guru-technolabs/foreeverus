      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Add Video Plan</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" action="{{ route('video_plan.store') }}">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="plan_name" type="text" class="validate" value=""
                  ...
                  <div class="row">
                    <div class="col s12 input-field">
                      <input id="name" name="min" type="text" class="validate" value=""
                        data-error=".errorTxt2">
