      ...
      <div class="card-content">
        ...
        <div class="card-title">
          <div class="row">
            <div class="col s12 m6 l10">
              <h4 class="card-title">Privacy And Cookie Policy</h4>
            </div>
          </div>
        </div>
        <div id="view-input-fields">
          <div class="row">
            <div class="col s12">
              <br>
              <form class="row" method="post" action="{{url('/')}}/update_privacy_and_cookie_policy">
                @csrf
                <div class="col s12">
                 <!-- <div class="input-field col s12">
                    <input placeholder="Title" id="first_name1" type="text" value="{{$privacy_and_cookie_policy->title}}" name="title" class="validate">
                  ...
                  <div class="input-field col s12">
                    <textarea class="ckeditor form-control validate" name="description">{{$privacy_and_cookie_policy->description}}</textarea>
