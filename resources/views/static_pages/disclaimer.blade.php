      ...
      <div class="card-content">
        ...
        <div id="view-input-fields">
          <div class="row">
            <div class="col s12">
              <br>
              <form class="row" method="post" action="{{url('/')}}/update_disclaimer">
                @csrf
                <div class="col s12">
                 <!-- <div class="input-field col s12">
                    <input placeholder="Title" id="first_name1" type="text" value="{{$disclaimer->title}}" name="title" class="validate">
                  ...
                  <div class="input-field col s12">
                    <textarea class="ckeditor form-control validate" name="description">{{$disclaimer->description}}</textarea>
