      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Add Coin Plan</span>
          </a>
        </li>
<!--         <li class="tab">
      ...
      <div class="row">
        <div class="col s12" id="account">
          <form id="accountForm" method="post" action="{{url('add_coin_plan')}}">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                ...
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="price" type="text" class="validate" value=""
                      data-error=".errorTxt2">
