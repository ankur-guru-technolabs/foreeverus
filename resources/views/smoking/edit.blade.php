...
{{-- page title --}}
@section('title','Edit Smoking Status')
      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Edit Smoking Status</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" action="{{ route('smoking.update',$smoking->id)}}}">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="title" type="text" class="validate" value="{{ $smoking->title}}"
                      data-error=".errorTxt2">
                    <label for="name">Smoking Status</label>
                    @if ($errors->has('title'))
