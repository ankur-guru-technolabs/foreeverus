      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Passion</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" action="{{ route('passion.store') }}">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="passion" type="text" class="validate" value=""
                      data-error=".errorTxt2">
                    <label for="name">Passion</label>
                    @if ($errors->has('passion'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('passion') }}</small>
                     @endif
                  </div>
                </div>
              </div>
