...
{{-- page title --}}
@section('title','Edit Video Call Plan')
      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Edit Video Call Plan</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" action="{{ route('video_plan.update',$videoCallPlan->id)}}}">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="plan_name" type="text" class="validate" value="{{ $videoCallPlan->plan_name}}"
                      data-error=".errorTxt2">
                    <label for="name">Plan Name</label>
                    @if ($errors->has('plan_name'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('plan_name') }}</small>
                     @endif
                  </div>
                </div>
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="min" type="text" class="validate" value="{{ $videoCallPlan->min}}"
                      data-error=".errorTxt2">
                    <label for="name">Minute</label>
                    @if ($errors->has('min'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('min') }}</small>
                     @endif
                  </div>
                </div>
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="coin" type="text" class="validate" value="{{ $videoCallPlan->coin}}"
                      data-error=".errorTxt2">
