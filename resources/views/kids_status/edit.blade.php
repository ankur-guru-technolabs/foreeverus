...
{{-- page title --}}
@section('title','Edit Kids Status')
      ...
      <ul class="tabs mb-2 row">
        <li class="tab">
          <a class="display-flex align-items-center active" id="account-tab" href="#account">
            <i class="material-icons mr-1"></i><span>Edit kids Status</span>
          </a>
        </li>
<!--         <li class="tab">
...
<!--           <div class="media display-flex align-items-center mb-2">
          ...
          <form id="accountForm" method="post" action="{{ route('kids.update',$kids->id)}}">
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    <input id="name" name="kids_status" type="text" class="validate" value="{{ $kids->kids_status}}"
                      data-error=".errorTxt2">
                    <label for="name">Kids Status</label>
                    @if ($errors->has('kids_status'))
                        <small class="errorTxt1" style="color: red;">{{ $errors->first('kids_status') }}</small>
                     @endif
                  </div>
                </div>
              </div>
